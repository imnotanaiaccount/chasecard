...
async function getCardsForSet(setId){
  const key = 'cache_cards_v9_' + setId; // v3->v4: JP rarity; v4->v5: pokemontcg.io image fallback; v5->v6: fixed fallback to use English name; v6->v7: curated Trainer names; v7->v8: dexId-based fallback; v8->v9: a genuinely empty card list from TCGdex/pokemontcg.io was being cached and returned as valid data, producing "Card 1/0" broken packs — now treated as a failure instead

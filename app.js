...
function resolveAndAppendSetCard(s, myGen, gridEl) {
  return (async () => {
    ...
    card.innerHTML = `<img src="" onerror="this.src='data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxIiBoZWlnaHQ9IjEiPjwvc3ZnPg==';this.classList.add('loaded')" onload="this.classList.add('loaded')" alt=""/><div class="meta">${metaYear}</div><div class="name-row"><div class="name">${s.name}</div><div class="cost-badge">${costDisplay} cr</div></div>`;
...
function applyCardSearchVisibility(card) {
  ...
  card.classList.toggle('no-match', !nameEl.textContent.toLowerCase().includes(q));
}

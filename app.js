...
function renderBattleBadgesSection(userProfile){
  ...
  return `
    <div class="battle-badges-section">
      ...
      <p class="hint" style="margin:0 0 10px;">Each trophy needs more wins than the last. All 8 unlocks Champion status and permanent VIP Rank.</p>
...
function renderBattleHome(){
  ...
  wrap.innerHTML = `
    <div class="section-title">Battle</div>
    <div class="hint" style="margin:-4px 0 14px;">Original card-duel mode — win battles to earn Battle Trophies. Beat all 8 for Champion status and permanent VIP Rank.</div>
      ...
      <div id="admin-panel" style="display:none; margin-top:30px; padding:18px; background:var(--panel-2); border:1px solid var(--vip-gold-dim); border-radius:14px; box-shadow: 0 4px 15px rgba(255, 233, 184, 0.1);">
         ...
         <div style="margin-bottom:12px;">
             ...
             <select id="admin-target-tier-select" aria-label="Target rank" style="width:100%; padding:12px 14px; border-radius:12px; border:1px solid var(--edge); background:var(--panel); color:var(--text); font-family:var(--font-body);">
                 <option value="rookie">Rookie (base rank, 250 daily credits)</option>
                 <option value="starter">Starter (1,250 daily credits)</option>
                 <option value="plus">Plus (2,500 daily credits)</option>
                 <option value="pro">Pro (5,000 daily credits)</option>
                 <option value="elite">Elite (10,000 daily credits)</option>
                 <option value="vip">VIP Member (25,000 daily credits)</option>

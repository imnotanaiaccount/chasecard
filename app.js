...
const ACHIEVEMENT_META = {
  ...
  dealmaker:     { label: 'Dealmaker',     desc: 'Completed 25 trades',                statKey: 'trades_count', threshold: 25 },
  dealer:        { label: 'Dealer',        desc: 'Sold 50 cards on the market',        statKey: 'sales_count', threshold: 50 },
  ...
  collector:     { label: 'Collector',     desc: 'Completed 5 full sets',              statKey: 'sets_completed_count', threshold: 5 },
...
// know how much to show in the unlock celebration below, never to
// actually grant anything (the server is the source of truth for the
// real balance).
const ACHIEVEMENT_REWARDS = {
  first_pull: 100,
  first_trade: 150, dealmaker: 500,
  dealer: 500, high_roller: 750,
  set_complete: 250, collector: 1000, whale_watcher: 300,
};
let myAchievements = [];
  ...
  Object.keys(ACHIEVEMENT_META).forEach(key => {
    ...
    if (!earned && meta.statKey) {
      ...
      progressText = meta.statKey === 'max_sale'
        ...
        : `${cur.toLocaleString()} / ${meta.threshold.toLocaleString()}`;
    }

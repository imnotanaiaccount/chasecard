...
// NON-ESSENTIAL flourish (confetti, sparks, screen shake, the legendary
// dim/godray/banner overlays, holo tilt) rather than core interaction
// animations (the pack tear, the flip itself) — turning it on should
// calm the celebration, not break the ability to actually open a pack.
...
function reducedMotion(){ return store.get('reduce_motion', false); }
function setReducedMotion(v){ store.set('reduce_motion', v); }
...
async function renderProfile() {
  ...
  wrap.innerHTML = `
      ...
      <div style="margin-top:18px; padding-top:16px; border-top:1px solid var(--edge);">
        ...
        <p class="hint" style="margin:2px 0 10px;">Turns off confetti, screen shake, the legendary godray/banner overlays, holo tilt, and haptic buzzing during pack opening. The pack tear and card flip stay — this only calms the celebration on top.</p>
      ...
      setTimeout(()=>{
        ...
        setTimeout(()=>{
          ...
          if(isLegendary){
            ...
            if(!reducedMotion()) screen.classList.add('shake'); setTimeout(()=>screen.classList.remove('shake'), 600);
            ...
            if(!reducedMotion()) screen.classList.add('shake'); setTimeout(()=>screen.classList.remove('shake'), 500);

...
function renderTierProgressBanner(userProfile) {
  ...
  const footer = p.maxed ? '' : `
    ...
    <div class="tier-progress-footer">
      ...
      <span class="${p.fasterPath === 'referrals' ? 'lead' : ''}">🤝 ${p.referrals.toLocaleString()}/${next.referrals.toLocaleString()} referrals</span>
    </div>`;
...
function renderAccountArea(user, userProfile) {
  ...
  const accountHtml = `
    <div class="account-card">
      ${user ? renderTierProgressBanner(userProfile) : ''}

...
// granted server-side in sync_achievements (see the Supabase migration
// achievements_grant_credits_on_unlock). Kept in sync manually since the
// RPC returns void; this is only used client-side to know how much to
// show in the unlock celebration below, never to actually grant anything
// (the server is the source of truth for the real balance).

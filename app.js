    ...
    if (hasFounding) {
      rows.push(`
        <div class="tier-ladder-row current-tier-row" style="--tier-color:${FOUNDING_COLOR};">
          ...
          <span class="req">${userProfile.founding_member_number ? `Founder #${userProfile.founding_member_number} — ` : ''}${isAdmin ? '2× earned credits (no effect — unlimited credits already)' : '2× earned credits, forever'}</span>
      ...
      rows.push(`
        <div class="tier-ladder-row" style="opacity:0.65;">
          ...
          <span class="name">Founding Member</span>
          <span class="req">Not earned on this account, and wouldn't do anything if it were — admin accounts already have unlimited credits</span>
        </div>`);
    } else {
      rows.push(`
